...
class GUMP
{
     ...
     * @return string
     */
    public function get_key_and_value_errors($convert_to_string = false, $field_class = 'gump-field', $error_class = 'gump-error-message')
    {
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_required' :
                    $resp[$e['field']] = "$field is required";
                    break;
                case 'validate_valid_email':
                    $resp[$e['field']] = "$field is required to be a valid email address";
                    break;
                case 'validate_max_len':
                    $resp[$e['field']] = "$field needs to be $param or shorter in length";
                    break;
                case 'validate_min_len':
                    $resp[$e['field']] = "$field needs to be $param or longer in length";
                    break;
                case 'validate_exact_len':
                    $resp[$e['field']] = "$field needs to be exactly $param characters in length";
                    break;
                case 'validate_alpha':
                    $resp[$e['field']] = "$field may only contain alpha characters(a-z)";
                    break;
                case 'validate_alpha_numeric':
                    $resp[$e['field']] = "$field may only contain alpha-numeric characters";
                    break;
                case 'validate_alpha_dash':
                    $resp[$e['field']] = "$field may only contain alpha characters &amp; dashes";
                    break;
                case 'validate_numeric':
                    $resp[$e['field']] = "$field may only contain numeric characters";
                    break;
                case 'validate_integer':
                    $resp[$e['field']] = "$field may only contain a numeric value";
                    break;
                case 'validate_boolean':
                    $resp[$e['field']] = "$field may only contain a true or false value";
                    break;
                case 'validate_float':
                    $resp[$e['field']] = "$field may only contain a float value";
                    break;
                case 'validate_valid_url':
                    $resp[$e['field']] = "$field is required to be a valid URL";
                    break;
                case 'validate_url_exists':
                    $resp[$e['field']] = "The $field URL does not exist";
                    break;
                case 'validate_valid_ip':
                    $resp[$e['field']] = "$field needs to contain a valid IP address";
                    break;
                case 'validate_valid_cc':
                    $resp[$e['field']] = "$field needs to contain a valid credit card number";
                    break;
                case 'validate_valid_name':
                    $resp[$e['field']] = "$field needs to contain a valid human name";
                    break;
                case 'validate_contains':
                    $resp[$e['field']] = "$field needs to contain one of these values: ".implode(', ', $param);
                    break;
                case 'validate_contains_list':
                    $resp[$e['field']] = "$field needs contain a value from its drop down list";
                    break;
                case 'validate_doesnt_contain_list':
                    $resp[$e['field']] = "$field contains a value that is not accepted";
                    break;
                case 'validate_street_address':
                    $resp[$e['field']] = "$field needs to be a valid street address";
                    break;
                case 'validate_date':
                    $resp[$e['field']] = "$field needs to be a valid date";
                    break;
                case 'validate_min_numeric':
                    $resp[$e['field']] = "$field needs to be a numeric value, equal to, or higher than $param";
                    break;
                case 'validate_max_numeric':
                    $resp[$e['field']] = "$field needs to be a numeric value, equal to, or lower than $param";
                    break;
                case 'validate_starts':
                    $resp[$e['field']] = "$field needs to start with $param";
                    break;
                case 'validate_extension':
                    $resp[$e['field']] = "$field can have the following extensions $param";
                    break;
                case 'validate_required_file':
                    $resp[$e['field']] = "$field is required";
                    break;
                case 'validate_equalsfield':
                    $resp[$e['field']] = "$field does not equal $param field";
                    break;
                case 'validate_min_age':
                    $resp[$e['field']] = "$field needs to have an age greater than or equal to $param";
                    break;
                default:
                    $resp[$e['field']] = "$field is invalid";
            }
        }
